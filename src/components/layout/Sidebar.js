...
function ConnectionFooter() {
    ...
    return (_jsx("div", { className: "border-t border-hairline p-3", children: _jsxs("div", { className: "rounded-lg border border-hairline bg-overlay/60 p-3", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("p", { className: "font-mono text-[9px] uppercase tracking-[0.18em] text-ink-3", children: "Model status" }), _jsx(StatusDot, { tone: tone, pulse: connection === "live", size: "sm" })] }), _jsxs("p", { className: "mt-1.5 font-mono text-xs text-ink", children: [label, modelVersion && _jsxs("span", { className: "text-ink-3", children: [" \u00B7 v", modelVersion] })] }), _jsxs("p", { className: "mt-0.5 flex items-center gap-1 font-mono text-[10px] text-ink-3", children: [_jsx(TriangleAlert, { className: "h-3 w-3", strokeWidth: 1.5 }), "Decision support only"] })] }) }));
}
function NavList({ onNavigate }) {
    return (_jsxs("nav", { className: "flex-1 space-y-1 px-3", "aria-label": "Primary", children: [_jsx("p", { className: "px-2 pb-1 pt-4 font-mono text-[9px] uppercase tracking-[0.2em] text-ink-3", children: "Workbench" }), NAV_ITEMS.map((item) => (_jsx(NavLink, { to: item.to, onClick: onNavigate, className: ({ isActive }) => cn("group relative flex items-center gap-3 rounded-lg px-2.5 py-2.5 text-sm transition-colors duration-150", isActive ? "bg-signal-dim/60 text-ink" : "text-ink-2 hover:bg-white/5 hover:text-ink"), children: ({ isActive }) => (_jsxs(_Fragment, { children: [isActive && (_jsx(motion.span, { layoutId: "nav-indicator", className: "absolute left-0 top-1/2 h-5 w-0.5 -translate-y-1/2 rounded-full bg-signal" })), _jsx(item.icon, { className: "h-4 w-4 shrink-0", strokeWidth: 1.6 }), _jsx("span", { className: "flex-1 truncate text-[13px] font-medium", children: item.label }), _jsx("span", { className: cn("font-mono text-[10px] tabular-nums", isActive ? "text-signal" : "text-ink-3 group-hover:text-ink-2"), children: item.index })] })) }, item.to)))] }));
}
